      ...
      <div className={classes.container}>
        <div className={classes.headingContainer}>
          <h1 className={classes.heading}>
            Empower Your Investments: Donate to the Islamic Private Education Secretariat Today!
          </h1>
          <p className={classes.caption}>
            The Islamic Private Education Secretariat with accronyn as (IPES) works to promote the
            rights to education of Muslim girls who have been relegated, internally displaced
            persons (IDPS) who are out of School and the economic empowerment of women and Minority
            groups.
          </p>
        </div>
        <div className={classes.info}>
          ...
          <div className={classes.infoRight}>
            ...
            <div style={{ marginBottom: '5rem' }}>
              ...
              {projectList && projectList.slice(0, 2).map((project: { _id: string; title: string; description: string; projectImage: { httpPath: string; }; }) =>
                <DonateProjectCard
                  key={project._id}
                  title={project.title}
                  description={project.description}
                  cover={project?.projectImage.httpPath || cover}
