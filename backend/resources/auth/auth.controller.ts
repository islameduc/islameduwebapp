...
class UserController implements Controller {
    ...
    private getAboutUs = async (
        req: Request,
        res: Response,
        next: NextFunction
    ): Promise<Response | void> => {
        try {
            const result = await this.authService.getAboutUs(req)
    ...
    private addAboutUsDetail = async (
        req: Request,
        res: Response,
        next: NextFunction
    ): Promise<Response | void> => {
        try {
            const detail = await this.authService.addAboutUsDetail(req)
    ...
    private updateAboutUs = async (
        req: Request,
        res: Response,
        next: NextFunction
    ): Promise<Response | void> => {
        try {
            const result = await this.authService.updateAboutUs(req)
