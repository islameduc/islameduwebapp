...
const detail_model_1 = __importDefault(require("./detail.model"));
...
class AuthService {
    ...
    getAboutUs(req) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                const data = yield detail_model_1.default.find({ isDeleted: false })
                    .exec();
                return data;
            }
            catch (error) {
    ...
    addAboutUsDetail(req) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                const existingDetail = yield detail_model_1.default.findOne({
                    title,
                    isDeleted: false
                }).exec();
                if (existingDetail) {
                    throw new http_exception_1.default(409, `A detail already exists with the title ${title}`);
                }
                const detail = yield new detail_model_1.default({
                    title,
                    content,
                    author: userId
                }).save();
    ...
    updateAboutUs(req) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                yield detail_model_1.default.findOneAndUpdate({ title: 'whoWeAre' }, { content: whoWeAre, author: userId });
                yield detail_model_1.default.findOneAndUpdate({ title: 'mission' }, { content: mission, author: userId });
                yield detail_model_1.default.findOneAndUpdate({ title: 'vision' }, { content: vision, author: userId });
                yield detail_model_1.default.findOneAndUpdate({ title: 'whatWeDo' }, { content: whatWeDo, author: userId });
                return {
                    whoWeAre,
                    mission,
                    vision,
