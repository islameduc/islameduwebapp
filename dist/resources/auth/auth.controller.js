...
class UserController {
    constructor() {
        ...
        this.getAboutUs = (req, res, next) => __awaiter(this, void 0, void 0, function* () {
            try {
                const result = yield this.authService.getAboutUs(req);
        ...
        this.addAboutUsDetail = (req, res, next) => __awaiter(this, void 0, void 0, function* () {
            try {
                const detail = yield this.authService.addAboutUsDetail(req);
        ...
        this.updateAboutUs = (req, res, next) => __awaiter(this, void 0, void 0, function* () {
            try {
                const result = yield this.authService.updateAboutUs(req);
                res.status(constants_1.STATUS_CODES.SUCCESS.SUCCESSFUL_REQUEST).json({
    ...
    initializeRoutes() {
        ...
        this.router.get(`${this.path}/about-us`, this.getAboutUs);
        this.router.post(`${this.path}/about-us`, [index_1.authJwt.isSuperAdmin], this.addAboutUsDetail);
        this.router.patch(`${this.path}/about-us`, [index_1.authJwt.isSuperAdmin], this.updateAboutUs);
    }
}
