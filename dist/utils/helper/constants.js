...
exports.FILE_STRUCTURE = {
    ...
    POST_IMAGE_DIR: path.join(process.cwd(), 'public', 'postImage'),
    CATEGORY_IMAGE_DIR: path.join(process.cwd(), 'public', 'categoryImage'),
    POST_VIDEO_DIR: path.join(process.cwd(), 'public', 'postVideo'),
...
const CONSTANTS = {
    ...
    MAINTAINER_EMAIL: exports.MAINTAINER_EMAIL,
